...
export class UserService
{
  ...
  getUsers(followParams?,userParams?): Observable<UserListDTO[]> {

    let params=new HttpParams();

    if(followParams ==='followers'){
      params=params.append('followers','true');   // querystring bilgileri şekillenmiş oluyor
    ...
    return this.http.get<UserListDTO[]>(this.baseUrl, {params: params});
  }
