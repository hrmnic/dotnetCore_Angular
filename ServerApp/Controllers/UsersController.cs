...
namespace ServerApp.Controllers
{
    ...
    public class UsersController: ControllerBase
    {
        ...
        public async Task<IActionResult> GetUsers([FromQuery] UserQueryParams userParams)
        {
            ...
            var users = await _repository.GetUsers(userParams);   // o an login olan user bilgileri gelmez
        ...
        {
            if (id != int.Parse(User.FindFirst(ClaimTypes.NameIdentifier).Value))  //user id bilgisi
            ...
            _mapper.Map(model,user);     //modelden gelen bilgiler set edildi
